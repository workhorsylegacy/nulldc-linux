...
ALIGN_MEM(64) u32 r[16];		//64 bytes : 1 cache line
ALIGN_MEM(64) f32 fr[16];		//64 bytes : 1 cache line
ALIGN_MEM(64) f32 xf[16];		//64 bytes : 1 cache line

ALIGN_MEM(64) u32 r_bank[8];
...
ALIGN_MEM(32) f32 sin_table[0x10000+0x4000];	//+0x4000 to avoid having to warp around twice on cos
